...
print inp , out,r, hidden_layers , nrns_in_layer , non_lnrty , learning_rate
# exit(0)
n  = 0.1
...
def predict_sig(TEST_SAMPLES,TEST_OUTPUT,net_output,net_parameters):
...
t0 = time.time()
predict_sig(TEST_SAMPLES,TEST_OUTPUT,net_output,network_parameters)
t1 = time.time()
